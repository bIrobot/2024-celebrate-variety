...
//bIrobot note: line above appeared as below in 2023 code
...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kIntakeAngularOffset = 0;
    
    // SPARK MAX CAN IDs
    public static final int kShooterLeftMotorCanId = 11;

    public static final int kIntakeIngestCanId = 9;
    public static final int kIntakeRotateCanId = 10;
  ...
  public static final class ModuleConstants {
    ...
    //bIrobot Note: these CurrentLimit settings were both set to 40 in last year's code
    //end note
  }
  ...
  public static final class ArmConstants {
    public static final double kClimberClimbSpeed = 1;
    public static final double kClimberReleaseSpeed = -1;
  ...
  public static final class IngestConstants {
    ...
    public static final double k_pivotAngleGround = 357;
    public static final double k_pivotAngleStow = 223;
    public static final double k_pivotAngleAmp = 121;
  }

  public static final class ShooterConstants {
      // Shooter
    public static final int kShooterLeftMotorId = 11;
    public static final int kShooterRightMotorId = 12;
    ...
    public static final double kShooterMaxOutput = 20;
  }
}
